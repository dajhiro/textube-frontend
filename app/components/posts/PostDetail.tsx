  ...
  return (
    <article className="mx-auto max-w-4xl">
      ...
      <section className="mx-auto max-w-4xl px-4">
        {/* Title */}
        <h1 className="mb-4 text-2xl font-bold leading-tight text-[var(--text-primary)] md:text-3xl">
          {post.title}
        </h1>
          ...
          <div className="flex items-center gap-3">
            <div className="relative h-12 w-12 flex-shrink-0 overflow-hidden rounded-full bg-[var(--surface-hover)]">
              <div className="flex h-full w-full items-center justify-center text-lg font-semibold text-[var(--text-secondary)]">
                <img src={post.channel.image} />
              </div>
            </div>
            <div>
              <div className="font-medium text-[var(--text-primary)]">{post.channel.name}</div>
